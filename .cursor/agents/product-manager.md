...
2. Read any existing context in `docs/prd/` and `docs/architecture/`
3. Write or update `docs/prd/<feature>.md` following the PRD template in `.cursor/rules/product-prd.mdc`
