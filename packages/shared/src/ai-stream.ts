...
export type AiStreamEvent =
  ...
  | AiStreamErrorEvent
  | AiStreamDoneEvent
  | AiStreamReportDeltaEvent
  | AiStreamCardsEvent
  | AiStreamSummaryDeltaEvent
  | AiStreamFindingEvent
  | AiStreamRecommendationEvent
  | AiStreamRiskEvent
  | AiStreamPriorityEvent
  | AiStreamTitleDeltaEvent
  | AiStreamDescriptionDeltaEvent
  | AiStreamBulletEvent
  | AiStreamNextStepEvent
  | AiStreamTalkingPointEvent;
