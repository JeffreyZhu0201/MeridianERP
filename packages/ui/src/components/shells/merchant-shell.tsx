...
const mainNav: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { href: '/inventory/warehouses', label: '仓库' },
      { href: '/inventory/stock', label: '库存水平' },
      { href: '/inventory/adjustments', label: '库存调整' },
      { href: '/inventory/alerts', label: '低库存预警' },
      { href: '/inventory/purchase-orders', label: '采购订单' },
      { href: '/inventory/reports', label: '报表' },
      { href: '/inventory/settings', label: '设置' },
    ],
  },
