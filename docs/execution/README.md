...
pnpm --filter @meridian/api prisma migrate dev
pnpm --filter @meridian/api prisma db seed
```
...
### Run individually (dev mode)

```bash
pnpm --filter @meridian/api dev
pnpm --filter @meridian/admin dev
pnpm --filter @meridian/merchant dev
```
