...
> **Superseded (2026-07-06):** Bindings-based metrics removed. See [`docs/handoffs/remove-branch-distributors-implementation.md`](../handoffs/remove-branch-distributors-implementation.md).
